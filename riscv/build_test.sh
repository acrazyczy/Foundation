...
# linking
${rpath}riscv32-unknown-elf-ld -T ./sys/memory.ld ./sys/rom.o ./test/test.o -L $prefix/riscv32-unknown-elf/lib/ -L $prefix/lib/gcc/riscv32-unknown-elf/10.2.0/ -lc /opt/riscv/lib/gcc/riscv32-unknown-elf/10.1.0/libgcc.a -lm -lnosys -o ./test/test.om
